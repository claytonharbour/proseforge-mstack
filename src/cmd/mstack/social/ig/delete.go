...
func NewDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "delete [media-id]",
		Short: "Delete an Instagram post",
		Long:  "Delete a post from Instagram by media ID.",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dryRun {
				...
				fmt.Fprintf(os.Stderr, "Would delete media: %s\n", mediaID)
				return nil
			}

			// Delete not yet implemented in service
			return fmt.Errorf("delete functionality not yet implemented for media %s", mediaID)
		},
	}
